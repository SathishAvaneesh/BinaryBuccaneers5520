...
@TeleOp(name="Test Arcade Two Stick", group="Test")
public class TestOpModeArcadeTwoStick extends OpMode
{
    ...
    public void loop() {
        ...
        telemetry.addData("Gyro Axis", "X Axis (%.2f), Y Axis (%.2f), Z Axis (%.2f), Heading (%.2f)",mrGyro.rawX(),mrGyro.rawY(),mrGyro.rawZ(),mrGyro.getHeading() );
